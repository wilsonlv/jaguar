package com.itqingning.core.base;

import com.baomidou.mybatisplus.core.conditions.Wrapper;
import com.baomidou.mybatisplus.core.metadata.IPage;
import com.baomidou.mybatisplus.extension.plugins.pagination.Page;
import com.itqingning.core.base.service.SysFieldEditLogService;
import com.itqingning.core.enums.OrderType;
import com.itqingning.core.util.ExecutorServiceUtil;
import com.itqingning.core.util.InstanceUtil;
...
//    }
    ...
    public static Page<Long> getPage(Map<String, Object> params) {
        ...
        OrderType order = (OrderType) params.get(ORDER);
        if (order == null) {
