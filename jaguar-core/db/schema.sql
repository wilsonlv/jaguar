...
(
    ...
    `remark_`     varchar(50) CHARACTER SET utf8mb4 COLLATE utf8mb4_bin  NULL     DEFAULT NULL,
    `create_by`   bigint(20)                                             NULL     DEFAULT NULL COMMENT '上次更新人',
    `create_time` datetime(0)                                            NULL     DEFAULT NULL COMMENT '上次更新时间',
    `update_by`   bigint(20)                                             NULL     DEFAULT NULL COMMENT '本次更新人',
    `update_time` datetime(0)                                            NULL     DEFAULT NULL COMMENT '本次更新时间',
