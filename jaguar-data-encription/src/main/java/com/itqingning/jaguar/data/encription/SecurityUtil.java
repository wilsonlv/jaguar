package com.itqingning.jaguar.data.encription;
...
import static com.itqingning.jaguar.data.encription.Constant.CHARSET_UTF_8;
...
public final class SecurityUtil {
    ...
    public static String signRSA(String data, String privateKey) {
        try {
            byte[] sign = RSACoder.sign(data.getBytes(CHARSET_UTF_8), decryptBASE64(privateKey));
    ...
    public static boolean verifyRSA(String data, String publicKey, String sign) {
        try {
            return RSACoder.verify(data.getBytes(CHARSET_UTF_8), decryptBASE64(publicKey), decryptBASE64(sign));
        } catch (Exception e) {
    ...
    public static String encryptRSAPrivate(String data, String privateKey) {
        try {
            return encryptBASE64(RSACoder.encryptByPrivateKey(data.getBytes(CHARSET_UTF_8), decryptBASE64(privateKey)));
        } catch (Exception e) {
            throw new RuntimeException("解密错误，错误信息：", e);
        }
    }
