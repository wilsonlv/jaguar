...
(
    ...
    `resource_ids`                   varchar(256) NOT NULL COMMENT '资源ID',
    `authorized_grant_types`         varchar(256) NOT NULL COMMENT '授权类型',
    `registered_redirect_uri`        varchar(512) NULL     DEFAULT NULL COMMENT '重定向URI',
...
(
    ...
    `server_secret`  varchar(200) NOT NULL COMMENT '服务密钥',
    `server_menu`    tinyint(1)   NOT NULL DEFAULT 0 COMMENT '是否展示菜单',
    `server_url`     varchar(512) NULL     DEFAULT NULL COMMENT '服务网址',
