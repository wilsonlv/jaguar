...
(
    ...
    `registered_redirect_uri`        varchar(256)  NULL     DEFAULT NULL COMMENT '重定向URI',
    `authorities_`                   varchar(256)  NULL     DEFAULT NULL COMMENT '权限',
    ...
    `additional_information`         varchar(4096) NULL     DEFAULT NULL COMMENT '其他信息',
