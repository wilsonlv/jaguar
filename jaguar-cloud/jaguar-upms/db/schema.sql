...
DROP TABLE IF EXISTS `jaguar_cloud_role`;
CREATE TABLE `jaguar_cloud_role`
(
    `id_`            bigint(20)   NOT NULL COMMENT 'ID',
...
INSERT INTO `jaguar_cloud_role`
VALUES (1419901871475785730, '超级管理员', 1, 1, null, null, null, null, null, null, null, 0);


DROP TABLE IF EXISTS `jaguar_cloud_user_role`;
CREATE TABLE `jaguar_cloud_user_role`
(
    `id_`            bigint(20)   NOT NULL COMMENT 'ID',
...
DROP TABLE IF EXISTS `jaguar_cloud_role_menu`;
CREATE TABLE `jaguar_cloud_role_menu`
(
    `id_`            bigint(20)   NOT NULL COMMENT 'ID',
    `role_id`        bigint(20)   NOT NULL COMMENT '角色ID',
...
INSERT INTO `jaguar_cloud_role_menu`
