package top.wilsonlv.jaguar.commons.pinyin;
...
public class PinyinUtil {
     ...
     * @return 拼音
     */
    private static String convertChinese2Pinyin(String hanzi, boolean isFull) {
     ...
     * @return 拼音
     */
    private static String convertSingleChinese2Pinyin(char hanzi) {
        try {
