package com.itqingning.jaguar.flowable.util;

import com.alibaba.fastjson.JSONObject;
import com.alibaba.fastjson.TypeReference;
import com.baomidou.mybatisplus.core.toolkit.IdWorker;
import com.itqingning.jaguar.flowable.enums.TaskFieldPermission;
import com.itqingning.jaguar.flowable.model.*;
import com.itqingning.jaguar.flowable.model.ExclusiveGateway;
import com.itqingning.jaguar.flowable.model.ParallelGateway;
import com.itqingning.jaguar.flowable.model.ServiceTask;
import com.itqingning.jaguar.flowable.model.UserTask;
...
import static com.itqingning.jaguar.flowable.Constant.*;
...
public class Bpmn20Util {
    ...
    public static FlowDefinition parseFlow(BpmnModel bpmnModel) {
        ...
        for (FlowElement flowElement : bpmnModel.getMainProcess().getFlowElements()) {
            if (flowElement instanceof StartEvent) {//开始节点
                ...
                UserTask userTask = parseUserTask(bpmnModel, (org.flowable.bpmn.model.UserTask) flowElement);
                ...
                ServiceTask serviceTask = parseServiceTask(bpmnModel, (org.flowable.bpmn.model.ServiceTask) flowElement);
                ...
                ExclusiveGateway exclusiveGateway = parseExclusiveGateway(bpmnModel,
                ...
                ParallelGateway parallelGateway = parseParallelGateway(bpmnModel,
     ...
     * 解析任务节点
     */
    public static UserTask parseUserTask(BpmnModel bpmnModel, org.flowable.bpmn.model.UserTask taskElement) {
     ...
     * 解析系统任务
     */
    private static ServiceTask parseServiceTask(BpmnModel bpmnModel, org.flowable.bpmn.model.ServiceTask service) {
     ...
     * 解析排他网关
     */
    private static ExclusiveGateway parseExclusiveGateway(BpmnModel bpmnModel, org.flowable.bpmn.model.ExclusiveGateway gateway) {
     ...
     * 解析平行网关
     */
    private static ParallelGateway parseParallelGateway(BpmnModel bpmnModel, org.flowable.bpmn.model.ParallelGateway gateway) {
    ...
    private static void convertUserTask(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (UserTask task : flowDefinition.getUserTaskList()) {
    ...
    private static void convertServiceTask(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (ServiceTask serviceTask : flowDefinition.getServiceTaskList()) {
    ...
    private static void convertExclusiveGateway(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (ExclusiveGateway exclusiveGateway : flowDefinition.getExclusiveGatewayList()) {
    ...
    private static void convertParallelGateway(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (ParallelGateway parallelGateway : flowDefinition.getParallelGatewayList()) {
