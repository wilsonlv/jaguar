package top.wilsonlv.jaguar.support.datamodifylog.aop;
...
import top.wilsonlv.jaguar.support.datamodifylog.service.DataModifyLogService;
...
public class DataModifyLogAspect {
    ...
    @Pointcut("execution(* top.wilsonlv.jaguar.commons.basecrud.BatchOperation.batchUpdateById(..))")
