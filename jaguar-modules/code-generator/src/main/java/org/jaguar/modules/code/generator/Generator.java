...
//        String outputDir = "/Users/apple/develop/data/generator";
        ...
        tc.setEntity("org/jaguar/modules/code/generator/template/entity.java.vm");
        tc.setMapper("org/jaguar/modules/code/generator/template/mapper.java.vm");
        tc.setXml("org/jaguar/modules/code/generator/template/mapper.xml.vm");
        tc.setServiceImpl("org/jaguar/modules/code/generator/template/service.java.vm");
        tc.setController("org/jaguar/modules/code/generator/template/controller.java.vm");
        mpg.setTemplate(tc);
        // 执行生成
        mpg.execute();
    }
