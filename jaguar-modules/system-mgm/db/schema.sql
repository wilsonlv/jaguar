...
(
    ...
    `password_free`      tinyint(1)                                            NOT NULL DEFAULT 0 COMMENT '免密登录',
    ...
    `create_time`        timestamp(0)                                                   DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
    `update_by`          bigint(20) UNSIGNED                                   NULL     DEFAULT NULL COMMENT '最新修改人',
    `update_time`        timestamp(0)                                                   DEFAULT CURRENT_TIMESTAMP(0) COMMENT '更新时间',
