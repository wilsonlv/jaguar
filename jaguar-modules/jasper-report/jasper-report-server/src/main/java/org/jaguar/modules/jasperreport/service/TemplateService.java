...
public class TemplateService extends BaseService<Template, TemplateMapper> {
    ...
    private static final String documentService = "documentService";
    ...
    public DocumentPersistenceService getDocumentPersistenceService(Template template) {
        String documentPersistenceServiceBean =
                StringUtils.isNotBlank(template.getTemplateUserDefinedPersistBean()) ?
                        template.getTemplateUserDefinedPersistBean() : documentService;
        return (DocumentPersistenceService) SpringContext.getBean(documentPersistenceServiceBean);
    }
