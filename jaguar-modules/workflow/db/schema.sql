...
(
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='表单数据附件表';
...
(
  ...
  CHARSET = utf8mb4 COMMENT ='工单操作记录表';

DROP TABLE IF EXISTS `jaguar_modules_workflow_process_remark`;
CREATE TABLE `jaguar_modules_workflow_process_remark`
(
    `id`              bigint(20)   NOT NULL COMMENT 'ID',
    `process_info_id` bigint(20)            DEFAULT NULL COMMENT '工单ID',
    `remark_user`     varchar(45)  NOT NULL COMMENT '记录人',
    `remark_time`     datetime     NOT NULL COMMENT '记录时间',
    `remark_content`  varchar(200) NOT NULL COMMENT '记录内容',
    `deleted_`        tinyint(1)   NOT NULL DEFAULT '0' COMMENT '逻辑删除标记(0--正常 1--删除)',
    `create_by`       bigint(20) unsigned   DEFAULT NULL COMMENT '创建人',
    `create_time`     timestamp    NOT NULL DEFAULT CURRENT_TIMESTAMP COMMENT '创建时间',
    `update_by`       bigint(20) unsigned   DEFAULT NULL COMMENT '最新修改人',
  ...
  DEFAULT CHARSET = utf8mb4 COMMENT ='工单备注表';