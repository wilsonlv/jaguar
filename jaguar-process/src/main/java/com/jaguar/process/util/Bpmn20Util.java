...
import static com.jaguar.process.Constant.*;
...
public class Bpmn20Util {
    ...
    public static FlowDefinition parseFlow(BpmnModel bpmnModel) {
        ...
        for (FlowElement flowElement : bpmnModel.getMainProcess().getFlowElements()) {
            if (flowElement instanceof StartEvent) {//开始节点
                ...
                com.jaguar.process.model.vo.UserTask userTask = parseUserTask(bpmnModel, (org.flowable.bpmn.model.UserTask) flowElement);
                ...
                com.jaguar.process.model.vo.ServiceTask serviceTask = parseServiceTask(bpmnModel, (org.flowable.bpmn.model.ServiceTask) flowElement);
                ...
                com.jaguar.process.model.vo.ExclusiveGateway exclusiveGateway = parseExclusiveGateway(bpmnModel,
                ...
                com.jaguar.process.model.vo.ParallelGateway parallelGateway = parseParallelGateway(bpmnModel,
     ...
     * 解析任务节点
     */
    public static com.jaguar.process.model.vo.UserTask parseUserTask(BpmnModel bpmnModel, org.flowable.bpmn.model.UserTask taskElement) {
        com.jaguar.process.model.vo.UserTask userTask = new com.jaguar.process.model.vo.UserTask();
     ...
     * 解析系统任务
     */
    private static com.jaguar.process.model.vo.ServiceTask parseServiceTask(BpmnModel bpmnModel, org.flowable.bpmn.model.ServiceTask service) {
        com.jaguar.process.model.vo.ServiceTask serviceTask = new com.jaguar.process.model.vo.ServiceTask();
     ...
     * 解析排他网关
     */
    private static com.jaguar.process.model.vo.ExclusiveGateway parseExclusiveGateway(BpmnModel bpmnModel, org.flowable.bpmn.model.ExclusiveGateway gateway) {
        com.jaguar.process.model.vo.ExclusiveGateway exclusiveGateway = new com.jaguar.process.model.vo.ExclusiveGateway();
     ...
     * 解析平行网关
     */
    private static com.jaguar.process.model.vo.ParallelGateway parseParallelGateway(BpmnModel bpmnModel, org.flowable.bpmn.model.ParallelGateway gateway) {
        com.jaguar.process.model.vo.ParallelGateway parallelGateway = new com.jaguar.process.model.vo.ParallelGateway();
    ...
    private static void convertUserTask(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (com.jaguar.process.model.vo.UserTask task : flowDefinition.getUserTaskList()) {
    ...
    private static void convertServiceTask(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (com.jaguar.process.model.vo.ServiceTask serviceTask : flowDefinition.getServiceTaskList()) {
    ...
    private static void convertExclusiveGateway(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (com.jaguar.process.model.vo.ExclusiveGateway exclusiveGateway : flowDefinition.getExclusiveGatewayList()) {
    ...
    private static void convertParallelGateway(BpmnModel bpmnModel, Process process, FlowDefinition flowDefinition, Map<String, FlowElement> nodeElementMap) {
        ...
        for (com.jaguar.process.model.vo.ParallelGateway parallelGateway : flowDefinition.getParallelGatewayList()) {
